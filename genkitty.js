...
var run = function() {
    ...
    var defaultSelector = 'body[data-ks-style]:not(.scheme_wood)';
...
dojo.declare("classes.managers.NummonStatsManager", com.nuclearunicorn.core.TabManager, {
    ...
    i18nData: {
        "en": {
            ...
            "getCatnipExtraKittens": "Additional Kittens Supported In Cold Winter",
    ...
    getCatnipExtraKittens: function(){
        ...
        baseDemand += game.getResourcePerTickConvertion('catnip');

        var demandPerKitten = baseDemand / game.village.getKittens();
            demandPerKitten *= 5 * (1 + game.timeAccelerationRatio());
        
        var kittenSurplus = (-1 * catnip / demandPerKitten);
        return kittenSurplus;
    },
    ...
    stats: {
        catnip: [
            ...
            {
                name: "getCatnipExtraKittens",
                // title: "Additional supportable kittens",
                val: 0,
            }
